<script lang="ts">
	...
	import testicularIcon from '$lib/assets/png/testicular.png';
	import infertilityIcon from '$lib/assets/png/infertility.png';
	import sexualHealthIcon from '$lib/assets/png/sexual-health.png';
